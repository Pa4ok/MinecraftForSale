...
- исправление зависания на рестарте из-за зависшего потока query или rcon
- обновление MySQL JDBC до 8.XX версии + добавление в ядро HikariPool 
- обновление SnakeYAML до 2.XX версии с исправлением RCE уязвимости
